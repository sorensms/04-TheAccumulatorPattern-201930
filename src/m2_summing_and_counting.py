...
Authors: David Mutchler, Vibha Alangar, Matt Boutell, Dave Fisher, Mark Hays,
         Aaron Wilkin, their colleagues, and Maddie.
...
def run_test_count_sines_from():
    ...
    # -------------------------------------------------------------------------
    # TOD: 4. Implement this TEST function.
    ...
    print('       actual:  ', answer)
    expected = 10
    answer = count_sines_from(7, 15)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)
    expected = 18
    answer = count_sines_from(2, 26)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)
    expected = 7
    answer = count_sines_from(8, 11)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)
    expected = 14
    answer = count_sines_from(5, 21)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)
...
def run_test_count_sines_vs_cosines():
    ...
    print('       actual:  ', answer)
    expected = 150
    answer = count_sines_vs_cosines(150)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)
    expected = 164
    answer = count_sines_vs_cosines(163)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)
    expected = 57
    answer = count_sines_vs_cosines(59)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)
    expected = 32
    answer = count_sines_vs_cosines(31)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)
